...
add_checkpoint("mid_room_1", "cross_boundary", {{"00571B",}, {"00571A",}})
add_checkpoint("early_corridor", "cross_boundary", {{"077212","06B712"}, {"077011","075B11"}})
...
-- Boris' left route is simplier
add_checkpoint("boris_t_4C", "target_pad", {borisID, 0x4C})
